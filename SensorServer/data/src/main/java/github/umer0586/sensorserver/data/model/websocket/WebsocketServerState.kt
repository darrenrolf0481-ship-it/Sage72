...
sealed interface WebsocketServerState {
    data class Running(val websocketServerInfo: WebsocketServerInfo) : WebsocketServerState
    data object Stopped : WebsocketServerState
    data class Error(val throwable: Throwable?) : WebsocketServerState
}
