 ...
 *
 */
package github.umer0586.sensorserver.data.model.http


sealed interface HttpServerState {
    data class Running(val httpServerInfo: HttpServerInfo) : HttpServerState
    data object Stopped : HttpServerState
    data class Error(val throwable: Throwable?) : HttpServerState
}